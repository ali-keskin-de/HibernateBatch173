...
public class RunnerFetch06 {
    public static void main(String[] args) {
        ...
        //bu kitabın sahibi
        //book.getStudent() // tek yönlü bir iliski kurdugumuzdan dolyi bu code'larla ulasamayiz student nesnesine book üzerinden.

        //id:1001 olan öğrencinin kitaplarını görelim
        Student06 student=session.get(Student06.class,1001);
        System.out.println("1001 id sahip student'in kitaplari : " + student.getBookList());
